# existing-mono-inrepo-noport-noingress-autodeploy-20250729114039
...
```
docker build -t existing-mono-inrepo-noport-noingress-autodeploy-20250729114039:latest .
docker run -p:5030:8080 existing-mono-inrepo-noport-noingress-autodeploy-20250729114039:latest
```
